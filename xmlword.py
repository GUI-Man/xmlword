...
class MyXmlFunc:
	...
	def Output(self,first_title_name,second_level_title_name,result_xlsx):
		...
		f2 = open(result_xlsx, "w+", encoding='utf-8')
	...
	def xmlinfo(self):
		...
		for paragraph in doc.paragraphs:
			if(paragraph.style.name!="Normal"):
				titleset.add(paragraph.style.name)
		return titleset
#
